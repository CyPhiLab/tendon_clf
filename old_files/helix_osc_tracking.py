...
def get_coriolis_and_gravity(model, data):
    ...
    # --- Gravity + bias at nominal velocity
    data.qvel[:] = qvel0
    ...
    # Extract gravity approximately (only valid if qvel ≈ 0)
    g = tau_base.copy()
...
def simulate_model(headless=False):
    ...
    if headless:
        ...
        while t < max_sim_time:
            ...
            task_error, q, dq, previous_solution, u = controller(model, data, invariants, previous_solution, S, trajectory)
...
if __name__ == "__main__":
    ...
    csv_path = "helix_osc_tracking.csv"
