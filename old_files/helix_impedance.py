...
def controller(model, data, invariants, previous_solution=None):
    ...
    try:
        ...
        tau_null = -N @ (50 * q + 10 * data.qvel)
        u = pinv_B @ (tau + 0*tau_null)
        data.ctrl = B @ u

    except:
        print(f"failed convergence\n")
        u = None  # <-- add this (explicit fallback)
        pass
    return task_error, q, dq, previous_solution, u
...
if __name__ == "__main__":
    ...
    csv_path = "helix_impedance_pos4.csv"
