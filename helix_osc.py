...
def controller(model, data, invariants, previous_solution=None, S=None):
    ...
    return task_error, q, dq, previous_solution, u_input
...
def simulate_model(headless=False):
    ...
    if headless:
        ...
        while (len(task_error_log) < 2 or
            ...
            task_error, q, dq, previous_solution, u = controller(model, data, invariants, previous_solution, S)
