...
#     # omega_sq = np.diag([100, 100, 100, 100, 100, 100])  * .5 # omega^2
...
#     objective = cp.Minimize(cp.square(cp.norm(dJ_dt @ dq + jac @ qdd - (500 * twist.reshape(-1,1)  - 10 * (jac @ dq)))) + 0.5 * cp.square(cp.norm(qdd))  + 0.02 * cp.square(cp.norm(u)) + 1000 * cp.square(dl)) 
...
# ----------------------------------------------------
    ...
    objective = cp.Minimize(cp.square(cp.norm(dJ_dt @ dq + jac @ qdd - (500 * twist.reshape(-1,1) - 20 * (jac @ dq)))) + 0.5 * cp.square(cp.norm(qdd))  + 0.5 * cp.square(cp.norm(u)) + 1000 * cp.square(dl)) 
